...
| family.jpg (site: family-1532x852.jpg, re-cropped 2026-07-15) | http://wildnaturestudio.com/assets/images/family-1532x852.jpg | 1532×852 native, cropped to 1152×852 (removed leftmost ~380px) | Business's own site asset | yes/none found | Craft page, diorama process gallery | Team photo in front of a winter wolf habitat diorama. Cropped 2026-07-15 (fix pass, advisory finding) to remove a wolf-pack-vs-boar predation vignette visible in the uncropped left portion of the diorama backdrop — the same category of image (`lion-1532x852.jpg`) already excluded elsewhere in this build as too intense for cold outreach; it wasn't caught originally because it was secondary/background, not the focal subject. Verified by direct crop + re-view: all 5 team members remain fully in frame, only calm/resting wolf mounts remain visible in the backdrop, no predation/gore. |
...
| diorama-waterhole.jpg (site: 81570583-...-1599x900.jpg) | http://wildnaturestudio.com/assets/images/81570583-4812-47d1-ab27-28a257bd0904-1599x900.jpg | 1599×900 | Business's own site asset | yes/none found | Craft page, dioramas & habitats section | **Corrected 2026-07-15 (fix pass, blocking finding):** actual content is a studio team member kneeling beside a taxidermied wolf mount on a rock/earth base, in an outdoor garden setting (stone wall, potted flowers, greenery) — not a wild boar/waterhole/deer/birds scene as originally captioned. The original alt text and caption were fabricated (did not match the file) per independent review. No genuine waterhole/boar/deer/birds diorama image exists anywhere in this business's sourced asset pool (checked full manifest and the "Do Not Claim" rejected-image list) so no swap was possible; the alt text and `<span class="photo-caption">` in `craft.html` were rewritten to accurately describe what the photo actually shows instead. Filename left unchanged to avoid an unnecessary extra diff; content now matches copy. |
